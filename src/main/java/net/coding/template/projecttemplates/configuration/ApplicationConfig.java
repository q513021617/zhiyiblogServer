package net.coding.template.projecttemplates.configuration;
...
import net.coding.template.projecttemplates.controller.HelloWorldController;

/**
 * Spring configuration for sample application.
 */
@Configuration
@ComponentScan({ "net.coding.template.projecttemplates.configuration" })
